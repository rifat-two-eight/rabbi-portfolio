...
export default function Portfolio() {
    return (
        <section className="px-6 max-w-7xl mx-auto pb-32 space-y-24">
            {/* Header */}
            <div className="space-y-12">
                ...
                <div className="flex justify-between items-center border-b border-white/10 pb-8">
                    ...
                    <button className="px-8 py-3 rounded-full border border-solid border-[#ff6b00] text-white font-bold text-sm hover:bg-[#FF6B00] hover:border-[#FF6B00] transition-all duration-300">
                        View All
                    </button>
                </div>
            </div>
            ...
            <div className="relative pt-10">
                <div className="grid grid-cols-12 items-center">
                    {/* Background Image */}
                    <div className="col-span-12 relative aspect-[18/7] rounded-2xl overflow-hidden bg-[#111111]/50 group">
                        <Image
                            src="/gathering.png"
                            alt="Gathering App"
                            fill
                    ...
                    {/* Glass Card */}
                    <div className="col-span-12 lg:w-[45%] lg:absolute lg:right-0 p-6 md:p-8 rounded-2xl space-y-5 mt-[-100px] lg:mt-0 z-10
                        bg-white/0.04
                        backdrop-blur-2xl
                        ...
                        <div className="inline-block border border-[#FF6B00] text-[#FF6B00] px-5 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">
                            Case Study
                        </div>
                        ...
                        <a
                            href="#"
                            className="inline-flex items-center gap-3 text-[#FF6B00] font-black text-sm uppercase tracking-wider group/link hover:brightness-110 transition-all"
                        >
                            View Case
            ...
            <div className="relative pt-24 lg:pt-10">
                <div className="grid grid-cols-12 items-center">
                    {/* Glass Card */}
                    <div className="col-span-12 lg:w-[45%] lg:absolute lg:left-0 p-6 md:p-8 rounded-2xl space-y-5 mb-[-100px] lg:mb-0 lg:mt-0 z-10 order-2 lg:order-1
                        bg-white/0.04
                        backdrop-blur-2xl
                        [background:linear-gradient(135deg,rgba(255,255,255,0.07)_0%,rgba(255,255,255,0.02)_100%)]
                        relative
                    ...
                    {/* Background Image */}
                    <div className="col-span-12 relative aspect-[18/7] rounded-2xl overflow-hidden bg-[#111111]/50 group order-1 lg:order-2">
                        <Image
                            src="/photopia.png"
                            alt="Photopia App"
                            fill
